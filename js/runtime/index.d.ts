...
export declare class Extension {
	...
	browse(
		page: number,
		token?: CancelToken | undefined | null,
	): Promise<EntryList>;
	search(
		page: number,
		filter: string,
...
export declare class ExtensionClient {
	constructor(
		loadData: (err: Error | null, key: string) => string,
		storeData: (err: Error | null, key: string, value: string) => void,
		doAction: (err: Error | null, action: Action) => void,
		requestPermission: (
			err: Error | null,
			permission: Permission,
			msg?: string | undefined | null,
		) => boolean,
		getPath: (err: Error | null) => string,
	);
}
...
export declare class ManagerClient {
	constructor(
		getClient: (err: Error | null, arg: ExtensionData) => ExtensionClient,
		getPath: (err: Error | null) => string,
	);
}
