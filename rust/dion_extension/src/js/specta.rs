...
//     fn gen_types() {
//         super::ts_with_cfg(
//             "../../js/dion_runtime_types/src/generated/data.d.ts",
...
// pub(crate) fn ts_with_cfg(path: &str, conf: &ExportConfiguration) -> Result<(), TsExportError> {
//     let mut out = "// This file has been generated. DO NOT EDIT.\n\n".to_string();
