...
impl Display for Error {
    fn fmt(&self, formatter: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            Error::UnexpectedType(msg) => formatter.write_fmt(format_args!("UnexpectedType: {}", msg)),
            Error::ConvertFail => todo!(),
            Error::Rquickjs(_) => todo!(),
...
impl<'de> Deserializer<'de> {
    ...
    pub fn from_str(input: Value<'de>) -> Self {
        Deserializer { input }
    }
}
...
impl<'de, 'a> de::Deserializer<'de> for &'a mut Deserializer<'de> {
        ...
        V: Visitor<'de>,
    {
        ...
        match curr.type_of() {
            ...
            rquickjs::Type::Exception => Err(Error::UnexpectedType("Exception".into())),
            rquickjs::Type::Promise => Err(Error::UnexpectedType("Promise".into())),
            rquickjs::Type::Constructor => Err(Error::UnexpectedType("Constructor".into())),
            rquickjs::Type::Function => Err(Error::UnexpectedType("Function".into())),
            rquickjs::Type::Module => Err(Error::UnexpectedType("Module".into())),
            rquickjs::Type::Symbol => Err(Error::UnexpectedType("Module".into())),

            rquickjs::Type::Undefined => visitor.visit_none(),
            rquickjs::Type::Null => visitor.visit_none(),
            rquickjs::Type::Bool => visitor.visit_bool(curr.get()?),
    ...
    where
        V: Visitor<'de>,
    {
        visitor.visit_bool(self.curr().get()?)
    }
    ...
    where
        V: Visitor<'de>,
    {
        visitor.visit_i8(self.curr().get()?)
    }
    ...
    where
        V: Visitor<'de>,
    {
        visitor.visit_i16(self.curr().get()?)
    }
    ...
    where
        V: Visitor<'de>,
    {
        visitor.visit_i32(self.curr().get()?)
    }
    ...
    where
        V: Visitor<'de>,
    {
        visitor.visit_i64(self.curr().get()?)
    }
    ...
    where
        V: Visitor<'de>,
    {
        visitor.visit_u8(self.curr().get()?)
    }
    ...
    where
        V: Visitor<'de>,
    {
        visitor.visit_u16(self.curr().get()?)
    }
    ...
    where
        V: Visitor<'de>,
    {
        visitor.visit_u32(self.curr().get()?)
    }
    ...
    where
        V: Visitor<'de>,
    {
        visitor.visit_char(self.curr().get()?)
    }
    ...
    where
        V: Visitor<'de>,
    {
        if self.curr().type_of()==Type::Null||self.curr().type_of()==Type::Undefined {
            visitor.visit_none()
        }else{
