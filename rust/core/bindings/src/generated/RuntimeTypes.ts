...
export type CustomUI = { "Text": { text: string, } } | { "Image": { image: string, header?: { [key in string]?: string }, } } | { "Link": { link: string, label?: string, } } | { "TimeStamp": { timestamp: string, display: TimestampType, } } | { "EntryCard": { entry: Entry, } } | { "Column": { children: Array<CustomUI>, } } | { "Row": { children: Array<CustomUI>, } };
