...
open class Hoster(
    ...
    // Fifth constructor parameter of the Anikku source-api. Extensions
    // construct Hoster with all five arguments (relying on the default), so
    // it must exist for their `NoSuchMethodError`-prone direct calls to link.
