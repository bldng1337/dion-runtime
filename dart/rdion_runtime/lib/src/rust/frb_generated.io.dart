...
class RustLibWire implements BaseWire {
  ...
  int JNI_OnLoad(ffi.Pointer<ffi.Void> vm, ffi.Pointer<ffi.Void> _reserved) {
    return _JNI_OnLoad(vm, _reserved);
  }

  late final _JNI_OnLoadPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>('JNI_OnLoad');
