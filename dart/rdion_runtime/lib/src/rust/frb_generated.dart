...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  Future<void> executeRustInitializers() async {
    await api.crateApiSimpleLetsInitAppHere();
  }
  ...
  @override
  int get rustContentHash => -471920449;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiSimpleLetsInitAppHere();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<EntryDetailed> crateApiSimpleSourceExtensionProxyDetail(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        var arg2 = cst_encode_Map_String_setting_None(settings);
        var arg3 =
            cst_encode_opt_box_autoadd_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerCancelToken(
                token);
  ...
  Future<void> crateApiSimpleLetsInitAppHere() {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        return wire.wire__crate__api__simple__lets_init_app_here(port_);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_unit,
        decodeErrorData: null,
      ),
      constMeta: kCrateApiSimpleLetsInitAppHereConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSimpleLetsInitAppHereConstMeta =>
      const TaskConstMeta(
  ...
  EntryDetailed dco_decode_entry_detailed(dynamic raw) {
    ...
    return EntryDetailed(
      ...
      settings: dco_decode_opt_Map_String_setting_None(arr[18]),
    );
  }
  ...
  Map<String, Setting>? dco_decode_opt_Map_String_setting_None(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_Map_String_setting_None(raw);
  }
    ...
    switch (raw[0]) {
      ...
      case 4:
        return SettingUI_Dropdown(
          label: dco_decode_String(raw[1]),
          options: dco_decode_list_dropdown_item(raw[2]),
        );
      default:
        throw Exception("unreachable");
    }
  ...
  DropdownItem sse_decode_dropdown_item(SseDeserializer deserializer) {
    ...
    return DropdownItem(label: var_label, value: var_value);
  }
  ...
  EntryDetailed sse_decode_entry_detailed(SseDeserializer deserializer) {
    ...
    var var_views = sse_decode_opt_box_autoadd_f_32(deserializer);
    var var_length = sse_decode_opt_box_autoadd_i_32(deserializer);
    var var_settings = sse_decode_opt_Map_String_setting_None(deserializer);
    return EntryDetailed(
        id: var_id,
        url: var_url,
        title: var_title,
  ...
  Map<String, Setting>? sse_decode_opt_Map_String_setting_None(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_Map_String_setting_None(deserializer));
    } else {
      return null;
    }
  }
  ...
  SettingUI sse_decode_setting_ui(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      ...
      case 4:
        var var_label = sse_decode_String(deserializer);
        var var_options = sse_decode_list_dropdown_item(deserializer);
...
// ignore: invalid_use_of_internal_member
  ...
  void sse_encode_entry_detailed(EntryDetailed self, SseSerializer serializer) {
    ...
    sse_encode_opt_box_autoadd_f_32(self.views, serializer);
    sse_encode_opt_box_autoadd_i_32(self.length, serializer);
    sse_encode_opt_Map_String_setting_None(self.settings, serializer);
  }
  ...
  void sse_encode_opt_Map_String_setting_None(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_Map_String_setting_None(self, serializer);
    }
  }
  ...
  void sse_encode_setting_ui(SettingUI self, SseSerializer serializer) {
    ...
    switch (self) {
      ...
      case SettingUI_Dropdown(label: final label, options: final options):
        sse_encode_i_32(4, serializer);
        sse_encode_String(label, serializer);
        sse_encode_list_dropdown_item(options, serializer);
    }
  }
