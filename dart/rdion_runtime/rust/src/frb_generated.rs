...
fn wire__crate__api__simple__ExtensionManagerProxy_get_extensions_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    that: impl CstDecode<
        RustOpaqueNom<
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "ExtensionManagerProxy_get_extensions",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| async move {
                transform_result_dco::<_, _, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || async move {
                        ...
                        let api_that_guard = api_that_guard.unwrap();
                        let output_ok = crate::api::simple::ExtensionManagerProxy::get_extensions(
                            &*api_that_guard,
                        )
                        .await?;
                        Ok(output_ok)
...
fn wire__crate__api__simple__ExtensionManagerProxy_new_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::DcoCodec, _>(
        ...
        move || {
            ...
            transform_result_dco::<_, _, ()>((move || {
                let output_ok =
                    Result::<_, ()>::Ok(crate::api::simple::ExtensionManagerProxy::new(&api_path))?;
                Ok(output_ok)
            })())
        },
    )
            ...
            move |context| async move {
                transform_result_dco::<_, _, ()>(
                    (move || async move {
                        ...
                        let output_ok = Result::<_, ()>::Ok({
                            crate::api::simple::ExtensionProxy::disable(&mut *api_that_guard).await;
                        })?;
                        Ok(output_ok)
                    })()
                    .await,
            ...
            move |context| async move {
                transform_result_dco::<_, _, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || async move {
                        ...
                        let mut api_that_guard = api_that_guard.unwrap();
                        let output_ok =
                            crate::api::simple::ExtensionProxy::enable(&mut *api_that_guard)
                                .await?;
                        Ok(output_ok)
                    })()
                    .await,
...
fn wire__crate__api__simple__ExtensionProxy_setting_ids_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    that: impl CstDecode<
        RustOpaqueNom<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<ExtensionProxy>>,
    >,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "ExtensionProxy_setting_ids",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| async move {
                transform_result_dco::<_, _, ()>(
                    (move || async move {
                        ...
                        let api_that_guard = api_that_guard.unwrap();
                        let output_ok = Result::<_, ()>::Ok(
                            crate::api::simple::ExtensionProxy::setting_ids(&*api_that_guard).await,
                        )?;
                        Ok(output_ok)
                    })()
                    .await,
...
fn wire__crate__api__simple__ExtensionProxy_setting_ids_filtered_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    that: impl CstDecode<
        RustOpaqueNom<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<ExtensionProxy>>,
    >,
    settingtype: impl CstDecode<dion_runtime::settings::Settingtype>,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "ExtensionProxy_setting_ids_filtered",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            let api_that = that.cst_decode();
            let api_settingtype = settingtype.cst_decode();
            move |context| async move {
                transform_result_dco::<_, _, ()>(
                    (move || async move {
                        let mut api_that_guard = None;
                        ...
                        let api_that_guard = api_that_guard.unwrap();
                        let output_ok = Result::<_, ()>::Ok(
                            crate::api::simple::ExtensionProxy::setting_ids_filtered(
                                &*api_that_guard,
                                &api_settingtype,
                            )
                            .await,
...
const _: fn() = || {
    match None::<dion_runtime::datastructs::CustomUI>.unwrap() {
        ...
        dion_runtime::datastructs::CustomUI::Image { image, header } => {
            let _: String = image;
...
mod io {
    ...
    #[no_mangle]
    pub extern "C" fn frbgen_rdion_runtime_wire__crate__api__simple__ExtensionManagerProxy_get_extensions(
        port_: i64,
        that: usize,
    ) {
        wire__crate__api__simple__ExtensionManagerProxy_get_extensions_impl(port_, that)
    }
    ...
    pub extern "C" fn frbgen_rdion_runtime_wire__crate__api__simple__ExtensionManagerProxy_new(
        ...
        wire__crate__api__simple__ExtensionManagerProxy_new_impl(path)
    }
    ...
    #[no_mangle]
    pub extern "C" fn frbgen_rdion_runtime_wire__crate__api__simple__ExtensionProxy_setting_ids(
        port_: i64,
        that: usize,
    ) {
        wire__crate__api__simple__ExtensionProxy_setting_ids_impl(port_, that)
    }

    #[no_mangle]
    pub extern "C" fn frbgen_rdion_runtime_wire__crate__api__simple__ExtensionProxy_setting_ids_filtered(
        port_: i64,
        that: usize,
        settingtype: i32,
    ) {
        wire__crate__api__simple__ExtensionProxy_setting_ids_filtered_impl(port_, that, settingtype)
    }
