...
class SourcePage extends StatefulWidget {
  ...
  const SourcePage({super.key, required this.controller});
...
class _SourcePageState extends State<SourcePage> {
  ...
  Future<void> _run() async {
    ...
    if (ext == null) {
      widget.controller.log('Source', 'No extension loaded', isError: true);
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Text('Source', style: theme.textTheme.headlineSmall),
