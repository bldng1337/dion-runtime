...
class MapSourcePage extends StatefulWidget {
  final PlaygroundController controller;

  const MapSourcePage({super.key, required this.controller});

  @override
  State<MapSourcePage> createState() => _MapSourcePageState();
}

class _MapSourcePageState extends State<MapSourcePage> {
  ...
  Future<void> _run() async {
    ...
    if (ext == null) {
      widget.controller.log('Map Source', 'No extension loaded', isError: true);
      return;
    }
    setState(() => _loading = true);
    final uid = _uidController.text;
    final label = 'Map Source (uid: "$uid")';
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Text('Map Source', style: theme.textTheme.headlineSmall),
